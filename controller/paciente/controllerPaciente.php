<?php
function tablaLogros($logros) {
    // Crear una tabla para mostrar los datos del JSON
    echo '<div id="div">';
    echo '<table id="registro-logros" class="registro-table">';
    echo '<thead><tr><th>Fecha</th><th>Nombre del Logro</th><th>Acciones Realizadas</th><th>Cómo me Siento</th><th>Premio Obtenido</th><th>Operaciones</th></tr></thead>';
    echo '<tbody>';
...
function tablaSensaciones($sensaciones) {
    ...
    echo '<thead><tr><th>Fecha</th><th>Ejercicio provocador</th><th>Número de repetición</th><th>Miedo máximo</th><th>Acciones</th></tr></thead>';
    echo '<tbody>';
    $rowCount = 0; // Contador de filas
...
function tablaEstadoAnimo($estadoAnimo) {
    // Crear una tabla para mostrar los datos del JSON
    echo '<div id="div">';
    echo '<table id="registro-estadoAnimo" class="registro-table">';
    echo '<thead><tr><th>Fecha</th><th>Emociones</th><th>Grado de intensidad </th><th>Sensaciones corporales</th><th>Operaciones</th></tr></thead>';
    echo '<tbody>';
    $rowCount = 0; // Contador de filas
...
function tablaPensamientos($pensamientos) {
    // Crear una tabla para mostrar los datos del JSON
    echo '<div id="div">';
...
function tablaRelajacion($relajacion) {
    ...
    echo '<thead><tr><th>Fecha</th><th>Momento del día</th><th>Relajación conseguida </th><th>Concentración conseguida</th><th>Operaciones</th></tr></thead>';
    echo '<tbody>';
    $rowCount = 0; // Contador de filas
